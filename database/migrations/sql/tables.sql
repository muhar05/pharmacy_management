...
CREATE TABLE IF NOT EXISTS medicines (
    ...
    price INT NOT NULL COMMENT 'Price per unit in the smallest currency unit (store as integer, e.g., 15000 for IDR 15,000)',
...
CREATE TABLE IF NOT EXISTS sales (
    ...
    total_amount INT NOT NULL COMMENT 'Total sale amount in the smallest currency unit (e.g., IDR without decimal)',

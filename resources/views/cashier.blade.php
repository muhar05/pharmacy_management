<x-app-layout>
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Cashier Cart</h2>
                            ...
                            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                ...
                                <div class="flex items-center justify-between md:order-3 md:justify-end">
                                    ...
                                    <div class="text-end md:order-4 md:w-32">
                                        <p class="text-base font-bold text-gray-900 dark:text-white">{{ formatRupiah($medicine->price) }}</p>
                                    </div>
                                </div>

                                <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                    <a href="#"
                                        class="text-base font-medium text-gray-900 hover:underline dark:text-white">{{ $medicine->name }} || {{ $medicine->category }}</a>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $medicine->description }}</p>
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Type : {{ $medicine->type }}</p>
                                </div>
                            </div>
                        </div>
                        @endforeach

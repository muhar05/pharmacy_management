                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <thead
                                        ...
                                        <tr>
                                            <th scope="col" class="px-4 py-3">Medicine ID</th>
                                            <th scope="col" class="px-4 py-3">Quantity</th>
                                            <th scope="col" class="px-4 py-3">ReStock Date</th>
                                        ...
                                        @else
                                            @foreach ($restocks as $restock)
                                                <tr
                                                    ...
                                                    <td class="px-4 py-2">
                                                        <span
                                                            class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{ $restock->quantity }}</span>
                                                    </td>
                                                    <td
                                                    ...
                                                    <td
                                                        class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        {{ $restock->medicine->supplier_name }}</td>
                                                    <td class="px-4 py-2">
                                                        {{ $restock->created_at }}
                                                    </td>
                                                    <td class="px-4 py-2">
